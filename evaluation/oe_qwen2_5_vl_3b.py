# evaluation/oe_qwen2_5_vl_3b.py
# Adapted from mcq_qwen2_5_vl_3b.py for open-ended questions using Qwen2.5-VL-3B-Instruct
# Non-deterministic generation: do_sample=True, temperature=0.2
# max_new_tokens=100 for concise responses
...
# python evaluation/oe_qwen2_5_vl_3b.py
# nohup python evaluation/oe_qwen2_5_vl_3b.py >> results/output_oe_qwen2_5_vl_3b.log 2>&1 &

# CUDA_VISIBLE_DEVICES=0 nohup python evaluation/oe_qwen2_5_vl_3b.py >> results/output_oe_qwen2_5_vl_3b.log 2>&1 &
...
# Model configuration
SEED = 0
MODEL_NAME = "Qwen/Qwen2.5-VL-3B-Instruct"  # As per the model card: https://huggingface.co/Qwen/Qwen2.5-VL-3B-Instruct
...
model_name_short = MODEL_NAME.split("/")[-1].replace("-", "_").replace(".", "_")
...
def generate_answer(model, processor, images, prompt, retries=3):
    ...
    image_inputs, video_inputs = process_vision_info(messages)  # video_inputs=None if only images
