...
# python evaluation/oe_internvl2_4b.py
# nohup python evaluation/oe_internvl2_4b.py >> results/output_oe_internvl2_4b.log 2>&1 &

# CUDA_VISIBLE_DEVICES=1 nohup python evaluation/oe_internvl2_4b.py >> results/output_oe_internvl2_4b.log 2>&1 &
...
# Model configuration
SEED = 0
MODEL_NAME = "OpenGVLab/InternVL2-4B"  # As per the model card: https://huggingface.co/OpenGVLab/InternVL2-4B
    ...
    for attempt in range(1, retries + 1):
        try:
            generation_config = dict(
                max_new_tokens=100,  # Suitable for open-ended responses
                do_sample=True,      # Non-deterministic output for OE
                temperature=0.2,
            )
            response = model.chat(
                tokenizer=tokenizer,
