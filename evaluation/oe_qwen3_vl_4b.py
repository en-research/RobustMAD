...
# python evaluation/oe_qwen3_vl_4b.py
# nohup python evaluation/oe_qwen3_vl_4b.py >> results/output_oe_qwen3_vl_4b.log 2>&1 &

# CUDA_VISIBLE_DEVICES=1 nohup python evaluation/oe_qwen3_vl_4b.py >> results/output_oe_qwen3_vl_4b.log 2>&1 &
...
def generate_answer(model, processor, images, prompt, retries=3):
    ...
    image_inputs, video_inputs = process_vision_info(messages, image_patch_size=16)  # Use 16 for Qwen3-VL
