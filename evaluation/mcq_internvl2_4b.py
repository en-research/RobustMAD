# evaluation/mcq_internvl2_4b.py
...
# python evaluation/mcq_internvl2_4b.py
# CUDA_VISIBLE_DEVICES=1 nohup python evaluation/mcq_internvl2_4b.py >> results/output_mcq_internvl2_4b.log 2>&1 &
