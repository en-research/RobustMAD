...
# python evaluation/oe_minicpm.py
# nohup python evaluation/oe_minicpm.py >> results/output_oe_minicpm.log 2>&1 &

# CUDA_VISIBLE_DEVICES=0 nohup python evaluation/oe_minicpm.py >> results/output_oe_minicpm.log 2>&1 &
